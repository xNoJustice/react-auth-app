  ...
  return (
    <section className="flex flex-col items-center justify-center max-h-screen pt-24">
      <div className="flex items-center justify-center w-96 px-6 bg-gray-100 shadow-xl rounded-xl dark:bg-gray-700 lg:max-w-full lg:px-16 xl:px-12">
        <div className="w-96">
          <h1 className="mt-8 text-xl font-semibold text-center text-black dark:text-gray-100 tracking-ringtighter sm:text-2xl title-font">
            Forgot Password
          </h1>
          <p className="mt-1 font-thin text-center text-black dark:text-gray-50">
            Please enter the email address you register your account with. We
            will send you reset password confirmation to this email
          </p>
          {success && (
            <div className="text-white px-3 py-3 border-0 rounded relative mb-4 mt-2 bg-green-500">
              <span className="inline-block align-middle mr-8">Email Sent</span>
              <button
